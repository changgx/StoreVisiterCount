...
public class ESClient {
    ...
    static Settings settings = ImmutableSettings.settingsBuilder().put(m)
            .put("cluster.name", Utils.getPropertiesValue("configuration.properties", "cluster.name")).
    ...
    static {
        try {
            ...
            String content = Utils.getPropertiesValue("configuration.properties", "cluster.ips");
