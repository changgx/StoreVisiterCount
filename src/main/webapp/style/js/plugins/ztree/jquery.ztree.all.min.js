...
(function (q) {
    var H, I, J, K, L, M, u, r = {}, v = {}, w = {}, N = {
            ...
            var a = b.target, c = h.getSetting(b.data.treeId), d = "", e = null, g = "", n = "", i = null, m = null, k = null;
            if (j.eqs(b.type, "mousedown"))n = "mousedown"; else if (j.eqs(b.type, "mouseup"))n = "mouseup"; else if (j.eqs(b.type, "contextmenu"))n = "contextmenu"; else if (j.eqs(b.type, "click"))if (j.eqs(a.tagName, "span") && a.getAttribute("treeNode" + f.id.SWITCH) !== null)d = j.getNodeMainDom(a).id,
                g = "switchNode"; else {
                if (k = j.getMDom(c, a, [{
                        tagName: "a",
                        attrName: "treeNode" + f.id.A
                    }]))d = j.getNodeMainDom(k).id, g = "clickNode"
            } else if (j.eqs(b.type, "dblclick") && (n = "dblclick", k = j.getMDom(c, a, [{
                    tagName: "a",
                    attrName: "treeNode" + f.id.A
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d, e) {
            if (!b.data.keep.leaf || !a || a.isParent)if (j.isArray(d) || (d = [d]), b.data.simpleData.enable && (d = h.transformTozTreeFormat(b, d)), a) {
                var g = k(a, f.id.SWITCH, b), n = k(a, f.id.ICON, b), o = k(a, f.id.UL, b);
            ...
            for (e = 0, g = b.async.autoParam.length; a && e < g; e++) {
                var o = b.async.autoParam[e].split("="), m = o;
                o.length > 1 && (m = o[1], o = o[0]);
                n[m] = a[o]
            }
            if (j.isArray(b.async.otherParam))for (e =
                                                       0, g = b.async.otherParam.length; e < g; e += 2)n[b.async.otherParam[e]] = b.async.otherParam[e + 1]; else for (var l in b.async.otherParam)n[l] = b.async.otherParam[l];
            ...
            b && (h.initCache(b), h.initRoot(b), l.unbindTree(b), l.unbindEvent(b), b.treeObj.empty(), delete r[b.treeId])
        }, expandCollapseNode: function (b, a, c, d, e) {
            var g = h.getRoot(b), n = b.data.key.children;
            if (a) {
                ...
                if (a.open == c)j.apply(e, []); else {
                    var c = k(a, f.id.UL, b), g = k(a, f.id.SWITCH, b), m = k(a, f.id.ICON, b);
        ...
        makeNodeUrl: function (b, a) {
            ...
            if (h.getNodeCache(b, a.tId)) {
                ...
                if (!b.data.keep.parent && g == 0)e.isParent = !1, e.open = !1, g = k(e, f.id.UL, b), j = k(e, f.id.SWITCH, b), o = k(e, f.id.ICON, b), i.replaceSwitchClass(e, j, f.folder.DOCU), i.replaceIcoClass(e,
                    ...
                    var m = e[d][g - 1], g = k(m, f.id.UL, b), j = k(m, f.id.SWITCH, b);
                    o = k(m, f.id.ICON, b);
    ...
    q.fn.zTree = {
        ...
        }, _z: {tools: j, view: i, event: l, data: h}, getZTreeObj: function (b) {
        ...
        init: function (b, a, c) {
            ...
            c = {
                setting: d, addNodes: function (a, b, c, f) {
                    ...
                    function l() {
                        var b = k(a, d).get(0);
                        if (b && f !== !1)if (b.scrollIntoView)b.scrollIntoView(!1);
                        else try {
                                b.focus().blur()
                            } catch (c) {
                            }
                ...
                getNodes: function () {
                    ...
                    function c() {
                        var b = k(a, d).get(0);
                        if (b)if (b.scrollIntoView)b.scrollIntoView(!1); else try {
                            b.focus().blur()
                        } catch (f) {
                        }
                    }
                    ...
                    if (s) {
                        ...
                        if (g.apply(e.callback.beforeDrop, [h.treeId, l, q, w, p], !0) == !1)f.selectNodes(x, l); else {
                            ...
                            a = function () {
                                ...
                                f.selectNodes(h, C);
                                if (a = o(C[0], e).get(0))if (a.scrollIntoView)a.scrollIntoView(!1); else try {
                                    a.focus().blur()
                                } catch (r) {
                                }
